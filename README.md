...
## Other features
Some generic features implemented are login modal, scroll-to-top button, banner image with caraousel effect, product tabs, dropdown menus, faq page with accordion, clicable side menus in all pages, seller page, related products caraousel effect, hamburger menu for small screens and tablets.
